...
| Table | Contents |
|---|---|
| `branch_drift_kpis` | One row per repo × direction (`drift_type = 'commit'`) |
| `branch_drift_evidence` | Individual commits and files |
| `executions` | Run outcome |
...
| Table | Contents |
|---|---|
| `branch_drift_kpis` | One row per repo × direction (`drift_type = 'content'`) |
| `branch_drift_evidence` | Individual files and change types |
| `executions` | Run outcome |
